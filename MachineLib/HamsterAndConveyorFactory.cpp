...
void HamsterAndConveyorFactory::Create(wxPoint2DDouble hamsterPosition, wxPoint2DDouble conveyorPosition)
{
    ...
    hamster->GetCagePolygon()->SetInitialPosition(hamsterPosition.m_x, hamsterPosition.m_y);
    ...
    conveyor->GetPolygon()->SetInitialPosition(conveyorPosition.m_x, conveyorPosition.m_y);
    ...
    pulley2->SetPosition1(conveyorShaft);
...
std::shared_ptr<Body> HamsterAndConveyorFactory::AddBall(double placement)
{
    ...
    ball->GetPolygon()->SetInitialPosition(mConveyor->GetPolygon()->GetPosition().m_x + placement,mConveyor->GetPolygon()->GetPosition().m_y + 26);
