...
void Machine1Factory::BeamAndSpinningArm(std::shared_ptr<Machine> machine)
{
    ...
    hamster->GetCagePolygon()->SetInitialPosition(-220, 185);
    ...
    arm->GetPolygon()->SetInitialPosition(hamster->GetShaftPosition().m_x, hamster->GetShaftPosition().m_y);
