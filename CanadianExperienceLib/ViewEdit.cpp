...
void ViewEdit::OnLeftDoubleClick(wxMouseEvent &event)
{
    ...
    if (hitActor != nullptr)
    {
        ...
        mSelectedActor = hitActor;
        mSelectedDrawable = hitDrawable;
        mSelectedDrawable->IsClicked(mParent);
...
///**
// * Handle an Edit>SetMachineNumber menu option
// * @param event The menu event
// */
//void ViewEdit::OnSetMachineNumber(wxCommandEvent &event)
//{
//
////    if (dlg.ShowModal() == wxID_OK)
////    {
////        // A machine has been selected
////        GetPicture()->GetMachine()->SetMachineNumber();
////    }
//
//}
