...
public:
    ...
    /**
     * Get the drawable placed position
     * @return The drawable placed position
     */
    wxPoint GetPlacedPosition() {return mPlacedPosition;}
    ...
    * @param r The new rotation angle in radians
    ...
    /**
     * Handle when the drawable is cliced
     * @param parent New parent pointer
     */
    virtual void IsClicked(wxFrame* parent) {}
};
